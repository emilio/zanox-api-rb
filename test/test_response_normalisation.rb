...
class ResponseNormalisationTest < Minitest::Test
  def test_response_normalisation
    ...
    assert_equal [ test_response_object, test_response_object ],
      Zanox::API.normalize_response({ items: "2", some_items: { some_item: [ test_response_object, test_response_object ] } })
